...
import { YouTube, SmartToy, Twitter, Plumbing } from '@mui/icons-material'
      ...
      <ThemeProvider theme={theme}>
        <CssBaseline>
          ...
          <ButtonGroup>
            ...
            <CustomButton icon={<SmartToy/>} caption="BOBBY BOT" color="orange" url="www.github.com/BobbyTheCatfish/bobby-bot"/>
            ...
            <CustomButton icon={<Plumbing/>} caption="PERSONA MODS" color="gray" url="www.gamebanana.com/members/2378136"/>
          </ButtonGroup>
        </CssBaseline>
      </ThemeProvider>
    </div>
